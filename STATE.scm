...
;; STATE.scm - Project state tracking for ambientops-composer
;; Media-Type: application/vnd.state+scm

(define-state ambientops-composer
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "ambientops-composer")
    (repo "hyperpolymath/ambientops-composer"))

  (project-context
    (name "ambientops-composer")
